...
const Product = () => {
  ...
  return (
    ...
    {/* ###### */}
      ...
      {data.map((el)=>(
      //  <ProductCard image={el.image} id={el.id} price={el.price} title={el.title} category={el.category} description={el.description}/>
// key={id}
        <div key={el.id} style={{border:"2px solid grey"}}>
